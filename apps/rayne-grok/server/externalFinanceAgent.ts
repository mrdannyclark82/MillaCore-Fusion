...
export class FinanceAgent {
  ...
  private transactionHistory = new Map<string, Array<{
    id: string;
    date: string;
    amount: number;
    type: 'debit' | 'credit';
  ...
  constructor() {
    ...
    console.log(`[${this.agentName}] Finance Agent initialized (v${this.version})`);
  }
   ...
   */
  async processCommand(command: ExternalAgentCommand): Promise<ExternalAgentResponse> {
